...
setwd("Analytics/Weeks/Week8-DataVisualization/Data")
...
# Create the ggplot object with the data and the aesthetic mapping. GNI: Gross National Income per capita
...
# Which region has  has a lot of countries with a very low fertility rate and a very low percentage of the population under 15?
